...
@section('contents')
    ...
    <div class="row">
        <div class="col-md-10 .col-md-offset-2">
            <form class="form-horizontal" action="{{route('admin.append')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        @foreach($roles as $role)
                            <label><input name="power[]" type="checkbox" value="{{$role->name}}" />{{$role->name}} </label>
                        @endforeach
                    </div>
                </div>
                {{csrf_field()}}
